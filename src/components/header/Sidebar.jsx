    ...
    <div className="">
      ...
      <div className="benefits group-list mt-2">
        ...
        <div className="list-body">
          <li>
            <div className="input-bullet active-bullet"></div>
            <span className="list-nm"><img className="ct-img" src="../images/mood.svg" alt="" />
              Mood</span>
          </li>
          <li>
            <div className="input-bullet"></div>
            <span className="list-nm"><img className="ct-img" src="../images/bed.svg" alt="" />
              Hormone,Sleep</span>
          </li>
          <li>
            <div className="input-bullet"></div>
          ...
          <li>
            <div className="input-bullet"></div>
            <span className="list-nm"><img className="ct-img" src="../images/bed.svg" alt="" /> View
              all Products</span>
          </li>
        </div>
      </div>
      ...
      <div className="category group-list mt-2">
        ...
        <div className="list-body">
          <li>
            <div className="input-bullet active-bullet"></div>
            <span><img className="ct-img" src="../images/nutrations.svg" alt="" />
              Nutrtions</span>
          </li>

          <li>
            <div className="input-bullet"></div>
            <span><img className="ct-img" src="../images/personal-care.svg" alt="" />
              Personal Care</span>
          </li>

          <li>
            <div className="input-bullet"></div>
            <span><img className="ct-img" src="../images/w-health.svg" alt="" />
              Women's health</span>
          </li>
