...
import { tabsInitialize } from '../../utils/tabInitialize.js';
import { Header, Sidebar, CountryList } from '../index.js';

import { useState, useEffect, useRef } from "react";

function HeaderIntialize({ showSearch = true, showDashboardMenu = true, pvBars = true, tabsMenuList = true }) {
  ...
  return (
    <header>
      <div className="navbar-section">
        <div className="nav">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            {showDashboardMenu && (
              <div ref={barMenuRef}
                className="dashboard-menu d-lg-none d-md-inline-block d-sm-inline-block d-inline-block" id='barMenu'
              >
            ...
            >
              ...
              >
                ...
                <div className="u-info mt-4">
                  <div className="img">
                    <img src="../images/girl-header.png" alt="" />
                  </div>
                ...
                <div className="account-items mt-4">
                  <div className="acc-item">
                    <div className="icon">
                      ...
                      >
                        <path
                          d="m24,23v1H2.5c-1.378,0-2.5-1.122-2.5-2.5V.024h1v21.476c0,.827.673,1.5,1.5,1.5h21.5Zm-18-2.976v-8h-1v8h1Zm4,0h1v-10h-1v10Zm5,0h1v-7h-1v7Zm6,0v-11.024h-1v11.024h1ZM10,3.707l5,5L22.854.854l-.707-.707-7.146,7.146-5-5-5.854,5.854.707.707,5.146-5.146Z"
                        />
                      </svg>
                    </div>
            ...
            <div className="offcanvas offcanvas-end" tabindex="-1" id="countryList">
      ...
      <div className="menu-item">
        <div className="container-fluid navbar-menu">
          ...
          <div className="right-items">
            {pvBars && (
              <div
                className="rangeline-mobile mt-3 d-flex align-items-center gap-2"
              >
                <div className="left">
                  <div
                    className="slider-w-pv d-flex justify-content-end gap-2 align-items-center"
                  >
                    <div className="slider-container w-100">
                      ...
                      <input
                        ...
                        max="100"
                        value="80"
                        className="range-slider range-slider-80"
                        disabled
                      />
                    </div>
      ...
      <div ref={shopByMenuRef}
        className="shopby-menu"
        style={{ display: showShopByMenu ? "block" : "none" }}>
        ...
        <div className="categories mt-3">
          ...
          <div className="accordion-list px-3 mt-3" id="">
            <div className="acr-it active">
              <div
                className="list-header d-flex align-items-center justify-content-between active"
              >
            ...
            <div className="acr-it">
              <div
                className="list-header d-flex align-items-center justify-content-between"
              >
                <div className="left d-flex align-items-center gap-2">
                  <img className="" src="../svg/personal-care.svg" alt="" />
            ...
            <div className="acr-it">
              ...
              >
                <div className="left d-flex align-items-center gap-2">
                  <img className="" src="../svg/nutrations.svg" alt="" />
            ...
            <div className="acr-it">
              ...
              >
                <div className="left d-flex align-items-center gap-2">
                  <img className="" src="../svg/w-health.svg" alt="" />
        ...
        <div className="benefits mt-3">
          ...
          <div className="products">
            <div className="products-item">
              <div className="icon">
                <img src="../svg/leaf-white.svg" alt="" />
              </div>
