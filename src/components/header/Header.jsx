  ...
  return (
    <header>
      ...
      {/* {subtotalCard && (
        <>
          <div
            className="subtotal-card d-flex align-items-center justify-content-between"
          >
            <div className="sb-tl">Subtotal: $287</div>
            <div className="cart-link">
              <a href="../html/cart-page.html">Go to Cart</a>
            </div>
          </div>

          <div className="subtotal-card subtotal-with-close">
            <div className="sb-tl">Subtotal: $287</div>
            <div className="cart-link">
              <a href="../html/cart-page.html">Go to Cart</a>
            </div>
            <div className="close-subtotal">
