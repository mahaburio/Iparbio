...
import { BsExclamationTriangle, BsEnvelope } from "react-icons/bs";
import { RiUser3Line } from "react-icons/ri";
import { GoSignOut } from "react-icons/go";

function HeaderIntializeRU({ logoSrc, showSearch = true, showDashboardMenu = true, pvBars = true, tabsMenuList = true, user, AllSidebar = true, AllSidebarForMobile = true, MeneBarSec = true, ReturnToCart = false, Sponsor = false }) {
  ...
  const accountItems = [
    ...
    {
      label: "Мой заказ", icon: (<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
    ...
    { label: "Настройка моего сайта", icon: <CiGlobe className='icon-icon' />, isIcon: true, },
    { label: "Мои возвраты", icon: <BsExclamationTriangle className='icon-icon' />, isIcon: true, },
    { label: "Менеджер профиля", icon: <RiUser3Line className='icon-icon' />, isIcon: true, },
    {
      label: "Налоговая информация", icon: (<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
    ...
    {
      label: "Пожертвование для детей Ipar", icon: (<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
    ...
    {
      label: "Параметр", icon: (<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
    ...
    { label: "Электронная почта", icon: <BsEnvelope className='icon-icon' />, isIcon: true, },
    { label: "выход", icon: <GoSignOut className='icon-icon' />, isIcon: true, },
  ];
  ...
  const accordionData = [
    {
      ...
      items: ["Минералы и антиоксиданты", "Иммунная поддержка", "Антиоксиданты", "Сон и стресс"],
    },
    {
      title: "Уход за телом и красота",
      icon: "../svg/personal-care.svg",
      items: ["Основное здоровье", "Минералы", "Кожа и волосы", "Иммунитет"],
    },
    {
      title: "Женское здоровье",
      icon: "../svg/nutrations.svg",
      items: ["Минералы", "Гормональный баланс", "Энергия", "Поддержка сна"],
    },
    {
      title: "Эко-дом",
      icon: "../svg/w-health.svg",
      items: ["Чистящие средства", "Безопасность", "Экологичность", "Органика"],
    },
    {
      title: "Оптимизаторы",
      icon: "../svg/w-health.svg",
      items: ["Энергия", "Сила", "Выносливость", "Концентрация"],
    },
    {
      title: "Инструменты бизнеса",
      icon: "../svg/w-health.svg",
      items: ["Материалы", "Обучение", "Семинары", "Аналитика"],
    },
  ];


  // Раздел со списками на русском языке

  const listSections = [
    {
      key: "nutrition",
      active: true, // только один должен быть активным
      groups: [
        {
          title: "Все товары",
          links: ["помощь", "испытатели", "специалисты и спикеры"],
        },
        {
          title: "Покупка по выгодам",
          links: [
            "помощь",
            "испытатели",
            "специалисты и спикеры",
            "помощь",
            "испытатели",
            "специалисты и спикеры",
          ],
  ...
  const productItems = [
    { label: "Новые продукты", image: "/images/product-1.webp", alt: "new-products" },
    { label: "Спецпредложения", image: "/images/product-1.webp", alt: "special-offers" },
    { label: "Бестселлеры", image: "/images/product-1.webp", alt: "bestsellers" },
    { label: "Гормоны и сон", image: "/images/product-1.webp", alt: "hormone-sleep" },
  ];

  const productItemsBenefits = [
    { icon: "/svg/leaf-white.svg", label: "Управление весом" },
    { icon: "/svg/leaf-white.svg", label: "Концентрация и ум" },
    { icon: "/svg/leaf-white.svg", label: "Сон и стресс" },
    { icon: "/svg/leaf-white.svg", label: "Иммунная защита" },
  ];
      ...
      <div className="navbar-section">
        <div className="nav">
          ...
          <div className="back-home-mb d-lg-none d-md-flex d-sm-flex d-flex">
            <a href=""><i className="ri-arrow-left-s-line"></i>
              Дом</a>
          </div>
            ...
            <div>
              <div className="sign-in" ref={signinRef} onClick={toggleAccount}>
                ...
                <div id="myAccountDetails" ref={accountRef} className={showAccount ? "block" : ""}>
                  ...
                  <h5 className="text-center">Мой счет</h5>
        ...
        <>
              ...
              <ul className="nav-list m-0 p-0" id="collapseMenu">
                ...
                {tabsMenuList && (
                  <div className="main-listed-wrapper">
                    <li>
                      <a href="">Магазин <i className="ri-arrow-down-s-line"></i></a>
          ...
          <div ref={shopByMenuRef} className="shopby-menu" style={{ display: showShopByMenu ? "block" : "none" }}>
            ...
            <div className="feaures">
              <h5 className="fw-bold px-3">Выбирайте по характеристикам</h5>
            ...
            <div className="categories mt-3">
              <h5 className="fw-bold px-3">Магазин по категориям</h5>
            ...
            <div className="benefits mt-3">
              <h5 className="fw-bold px-3">Сортировать по выгоде</h5>
...
export default HeaderIntializeRU;
